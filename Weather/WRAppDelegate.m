...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.mainViewController = [[WRMainViewController alloc]initWithNibName:@"WRMainViewController" bundle:nil];
    self.naviController = [[UINavigationController alloc]initWithRootViewController:_mainViewController];
